      ...
      <style jsx>{`
        ...
        .calc-container {
          ...
          background: ${isDarkMode 
            ...
            : 'linear-gradient(135deg, #F8F1E7 0%, #F0E8D8 100%)'};
        ...
        .calc-title {
          font-size: 2.5rem;
          font-weight: 600;
          color: ${isDarkMode ? '#F9FAFB' : '#2C3E50'};
          text-align: center;
          margin-bottom: 3rem;
          font-family: 'Poppins', sans-serif;
        }
        ...
        .progress-step {
          ...
          align-items: center;
          z-index: 2;
          background: ${isDarkMode ? '#374151' : '#F8F1E7'};
        ...
        .step-circle.inactive {
          background: ${isDarkMode ? '#6B7280' : '#BDC3C7'};
          color: white;
        }
        ...
        .step-label {
          font-weight: 500;
          font-size: 0.8rem;
          color: ${isDarkMode ? '#E5E7EB' : '#2C3E50'};
          text-align: center;
        ...
        .step-status {
          font-size: 0.7rem;
          color: ${isDarkMode ? '#9CA3AF' : '#7F8C8D'};
          margin-top: 0.25rem;
          text-align: center;
          width: 100%;
        }
        ...
        .benefit-item {
          ...
          font-size: 0.9rem;
          color: ${isDarkMode ? '#D1D5DB' : '#5D6D7E'};
          line-height: 1.4;
        }
        ...
        .product-select {
          width: 100%;
          padding: 1rem;
          border: 2px solid ${isDarkMode ? '#4B5563' : '#E8E8E8'};
          border-radius: 0.75rem;
          font-size: 1rem;
        ...
        .list-header {
          ...
          margin-bottom: 2rem;
          padding-bottom: 1rem;
          border-bottom: 2px solid ${isDarkMode ? '#374151' : '#F8F9FA'};
        }
        ...
        .product-item {
          padding: 1.5rem 0;
          border-bottom: 1px solid ${isDarkMode ? '#374151' : '#F1F2F6'};
          display: flex;
          align-items: flex-start;
          gap: 1rem;
          position: relative;
        ...
        .quantity-btn {
          width: 2.5rem;
          height: 2.5rem;
          border: 1px solid ${isDarkMode ? '#4B5563' : '#E8E8E8'};
        ...
        .delete-btn:hover {
          background: ${isDarkMode ? 'rgba(239, 68, 68, 0.1)' : '#FCE4EC'};
        }

        .total-section {
          margin-top: 2rem;
          padding-top: 2rem;
          border-top: 2px solid ${isDarkMode ? '#374151' : '#F8F9FA'};
        }
        ...
        .btn-secondary {
          background: ${isDarkMode ? '#4B5563' : '#6C757D'};
          color: white;
        }

        .btn-secondary:hover {
          background: ${isDarkMode ? '#374151' : '#545B62'};
        }
