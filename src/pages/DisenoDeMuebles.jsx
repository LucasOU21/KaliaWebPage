        ...
        <div style={responsiveStyles.heroContent}>
          ...
          <div style={responsiveStyles.heroText}>
            <h1 style={responsiveStyles.heroTitle}>
              Servicio Profesional de Armarios y Vestidores
            </h1>
          ...
          <div style={responsiveStyles.heroImageContainer}>
            <img
              ...
              alt="Servicio Profesional de Armarios y Vestidores"
            ...
            <div style={styles.contentSection}>
              <div style={responsiveStyles.contentGrid}>
                ...
                <div style={styles.featuresSection}>
                  <div>
                    <h3 style={styles.featureTitle}>Armarios a medida</h3>
                  ...
                  <div>
                    <h3 style={styles.featureTitle}>Cocina a medida</h3>
                    <p style={styles.featureText}>
                  ...
                  <div>
                    <h3 style={styles.featureTitle}>Recibidores y Almacenamiento Vertical</h3>
                    <p style={styles.featureText}>
