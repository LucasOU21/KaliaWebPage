// src/pages/ServiciosDeAcabados.jsx - Complete service detail page matching the Astro design
import React, { useState, useEffect } from 'react';

const ServiciosDeAcabados = () => {
          ...
          <div className="hero-content">
            <div className="hero-text">
              <h1 className="hero-title">
                Servicio Profesional de Acabados (Papel Pintado y Pintura)
              </h1>
                    ...
                    <div className="feature-item">
                      <div>
                        ...
                        <p className="feature-text">
                          Pintura de alta calidad para interiores.
                        </p>
                        <p className="feature-text">
                          Colocación de papel pintado moderno y decorativo.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className={`${activeTab === 1 ? '' : 'hidden'}`} role="tabpanel">
              <div className="content-section">
                <div className="gallery-grid">
                  ...
                  {/* Right Column - remaining 3 images */}
...
export default ServiciosDeAcabados;