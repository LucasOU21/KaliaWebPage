// src/pages/InstalacionPuertasTarimaRodapies.jsx - Complete service detail page matching the Astro design
import React, { useState, useEffect } from 'react';

const InstalacionPuertasTarimaRodapies = () => {
  ...
  // Split images into two columns - first 2 on left, rest on right (matching the HTML structure)
  ...
  return (
    <>
      <style jsx>{`
        ...
        /* Loading overlay matching Astro exactly */
        .overlay {
          position: fixed;
          inset: 0;
        ...
        /* Hero section matching Astro structure */
        .hero-section {
          max-width: 85rem;
          margin: 0 auto;
          display: flex;
        ...
        .cta-button:hover {
          background-color: #fbbf24; /* hover:bg-yellow-200 */
        ...
        /* Tab navigation matching Astro exactly */
        .tab-container {
          max-width: 85rem;
          margin: 0 auto;
        ...
        /* Image gallery matching Astro structure */
        .gallery-grid {
          display: grid;
          width: 100%;
      ...
      <div className="page-container">
        {/* Loading Overlay matching Astro */}
        <div className={`overlay ${!isLoading ? 'hidden' : ''}`}></div>

        {/* Hero Section matching Astro structure exactly */}
        <section className="hero-section">
          <div>
            ...
            {/* CTA Button positioned exactly like Astro */}
            <div>
          ...
          <div className="hero-content">
            <div className="hero-text">
              <h1 className="hero-title">
                Servicio de Instalación de Puertas, Tarima Flotante y Rodapiés
              </h1>
        ...
        <div className="tab-container">
          <nav className="tab-nav" aria-label="Tabs" role="tablist">
            {tabs.map((tab, index) => (
              <button
                ...
                role="tab"
              >
                <span className={`tab-text ${activeTab === index ? 'active' : ''}`}>
                  {tab.title}
                </span>
              </button>
            ))}
          ...
          {/* Tab Content matching Astro structure */}
          <div className="tab-content">
                ...
                <div className="content-grid">
                  <div className="content-main">
                    <h2 className="content-title">
                      Instalación de Puertas, Tarima Flotante y Rodapiés
                    </h2>
                    ...
                    <div className="feature-item">
                      <div>
                        ...
                        <p className="feature-text">
                          Instalamos puertas corredizas, puertas de seguridad y puertas interiores con precisión.
                        </p>
                        <p className="feature-text">
                          Colocación de tarima flotante y rodapiés para un acabado elegante y resistente.
                        </p>
                        <p className="feature-text">
                          Sistemas de puertas corredizas.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            {/* Images Tab matching Astro structure exactly */}
            <div className={`${activeTab === 1 ? '' : 'hidden'}`} role="tabpanel">
              <div className="content-section">
                <div className="gallery-grid">
                  ...
                  {/* Right Column - remaining 4 images */}
        ...
        {/* Fullscreen Modal matching Astro exactly */}
...
export default InstalacionPuertasTarimaRodapies;